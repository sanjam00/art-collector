...
export default function CreateArtworkReviewModal({ onClose, onCreated }) {
  ...
  return (
    <BottomSheet isOpen={true} onClose={onClose} title="New Artwork Review" size="large">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input className="form-control" value={dateCompleted} onChange={(e) => setDateCompleted(e.target.value)} placeholder="e.g. 1889 or c. 1889" />
        </div>
